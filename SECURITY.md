...
Until Benni reaches 1.0, security fixes are released on the latest minor
version. Upgrade to the latest published version before reporting an issue.

## Reporting a vulnerability

Do not open a public issue for a suspected vulnerability. Use GitHub's private
security advisory flow on the Benni repository instead:

https://github.com/ChiChuRita/benni/security/advisories/new
...
Benni sits on application data paths. Reports involving unsafe decoding,
